...
emoji_id = {
    ...
    "fnatic": 799522187803361300,
    "g2": 799520852990754818
}
...
def generate_embeds(list_of_games):
    ...
    for game in list_of_games:
        print('--- generate embed game')
        print(game.full_line)
...
def get_future_league_games():
    schedule = requests.get("https://lol.gamepedia.com/Special:RunQuery/MatchCalendarExport?pfRunQueryFormName=MatchCalendarExport&MCE%5B1%5D=LCK%2F2021+Season%2FSpring+Season%2CLCS%2F2021+Season%2FLock+In&wpRunQuery=Run+query&pf_free_text=").text
    soup = BeautifulSoup(schedule, 'html.parser')
